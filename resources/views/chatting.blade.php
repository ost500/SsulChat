    ...
    <script>
        ...
        Echo.join('testing').listen('.testing', (e) => {
            ...
            $('#chats').append("<ul id="+e.id+">" +
                ...
                "<li class=\"chat_text\">" + e.message + "<button style=\"border:0;background:transparent;margin-left: 3%;\" onclick=\"like(event)\"><img src=\"../images/gry_box_icon.png\"></img><div style=\"float:right\">0</div></button></li>" +
                "</ul>");
        $('.chat_txt_area2')[0].scrollTop = $('.chat_txt_area2')[0].scrollHeight;
