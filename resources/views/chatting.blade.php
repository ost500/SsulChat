...
//                                console.log(response);
                ...
                <div id="chats" class="chat_txt_area2">
                    ...
                    @foreach($chats as $chat)
                        <ul id="{{$chat->id}}">
                            <li class="chat_pic" style="background-image: url('../images/profile_default_img.png');"><div class="chat_profile_img" style="background-image: url('../images/chatpic01.png');"></div></li>
